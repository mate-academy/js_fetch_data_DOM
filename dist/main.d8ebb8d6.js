...
var url = 'https://mate-academy.github.io/phone-catalogue-static/api/phones.json';
...
var getPhonesDetails = function getPhonesDetails() {
  return request().then(function (item) {
    var arrOfNames = [];
    item.map(function (el) {
      return arrOfNames.push(el.name);
    });
    var div = document.createElement('div');
    var ul = document.createElement('ul');
    div.appendChild(ul);
    arrOfNames.forEach(function (el) {
      return ul.insertAdjacentHTML('afterbegin', "<li>".concat(el, "</li>"));
    });
